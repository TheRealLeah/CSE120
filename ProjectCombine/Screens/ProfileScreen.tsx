...
import { StyleSheet, Image, ImageBackground, Button, TouchableOpacity, TextInput, Alert, SafeAreaView } from "react-native";
...
function ProfileScreen(props) {
  ...
  return (
    ...
    >
      ...
      <Button
        title="Edit Name"
        onPress={() => Alert.prompt('Edit Name', 'Enter in new Name', nameChange => setNameChange(nameChange))}
      />
      </SafeAreaView>
      ...
      <Button
        title="Edit Bio"
        onPress={() => Alert.prompt('Edit Bio', 'Enter in new Bio', bioChange => setBioChange(bioChange))}
      />
      </SafeAreaView>
